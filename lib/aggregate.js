...
import { sourceTypeOf, sourceTypeLabel, TYPE_OTHER } from "./types.js?v=0.6.0";
...
export function makeBucket() {
  return { calls: 0, input: 0, uncached: 0, output: 0, reasoning: 0, cacheRead: 0, totalTokens: 0, latencyN: 0, latencySum: 0, latencyValues: [], errors: 0 };
}
...
const ROLLUP_BUCKET_FIELDS = ["calls", "input", "uncached", "output", "reasoning", "cacheRead", "totalTokens", "errors"];
...
function rollupBucket() { return { calls: 0, input: 0, uncached: 0, output: 0, reasoning: 0, cacheRead: 0, totalTokens: 0, errors: 0 }; }
